...
# Analista Acústico - device=-1 obriga a rodar na CPU
analista_emocao = pipeline("audio-classification", model="superb/hubert-large-superb-er", device=-1)

# Dicionário para traduzir o resultado pro Qwen entender
tradutor_emocao = {
    "neu": "Neutro / Tédio",
    "hap": "Animado / Feliz",
    "ang": "Irritado / Frustrado",
    "sad": "Desanimado / Triste"
}
